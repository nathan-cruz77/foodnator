"""
Django settings for foodnator project.
...
WSGI_APPLICATION = 'foodnator.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './foodnator.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
